...
const PILLARS = [
  ...
  {
    icon: Briefcase,
    label: "Contrata personal", // CAMBIO REALIZADO: Antes "Empleo"
...
const FAB_OPTIONS = [
  ...
  { icon: Briefcase,  label: "Contrata personal",     color: "#f59e0b", bg: "rgba(245,158,11,0.16)",  border: "rgba(245,158,11,0.40)",  action: "/jobs" },
